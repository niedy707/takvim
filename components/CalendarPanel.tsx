...
const translations = {
    ...
    en: {
        ...
        titleSuffix: 'Appointment Screen',
...
export default function CalendarPanel({ lastUpdate }: CalendarPanelProps) {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-6 font-sans">
            {/* Header */}
            <header className="flex flex-row justify-between items-stretch mb-8 gap-4 sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-sm p-4 -mx-4 rounded-b-xl transition-all">
                <div className="flex flex-col justify-center flex-1 min-w-0 mr-2">
                    <h1 className="flex flex-col justify-center">
                        ...
                        <span className="text-sm md:text-base font-medium text-gray-500 leading-tight ml-0.5">
                            {t.titleSuffix}
                        </span>
                    </h1>
                </div>
                ...
                <div className="flex flex-col gap-2 items-end justify-between">
                    ...
                    <span className="text-xs md:text-sm font-normal text-gray-500 block mt-auto">
